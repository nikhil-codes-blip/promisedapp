...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Convert the object of sessions to an array for easier consumption on the frontend
    return NextResponse.json(Object.values(sessions), { status: 200 })
  } catch (error: any) {
    console.error("API Error /api/admin/sessions:", error)
