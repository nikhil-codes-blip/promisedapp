...
const ADMIN_WALLET_ADDRESS =
  process.env.ADMIN_WALLET_ADDRESS?.toLowerCase() || "0xFb918BAC7ba0C324F573b2763CD4EC08cdEc5647".toLowerCase() // IMPORTANT: Use an environment variable for production!
...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    console.error("API Error /api/admin/delete-requests:", error)
